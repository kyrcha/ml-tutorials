...
paste("Accuracy in training all attributes", Accuracy(train_pred, trainData$Species), sep=" - ")
paste("Accuracy in training CFS attributes", Accuracy(train_simpler_pred, trainData$Species), sep=" - ")
paste("Accuracy in validation all attributes", Accuracy(pred, validationData$Species), sep=" - ")
paste("Accuracy in validation CFS attributes", Accuracy(simpler_pred, validationData$Species), sep=" - ")
```
